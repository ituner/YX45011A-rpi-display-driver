...
rm -f "${boot_dir}/overlays/yousee-yx45011act2.dtbo" /etc/systemd/system/yx45011a-display.service /etc/yx45011a-display.conf /usr/local/bin/yx45011a-display-test /usr/local/sbin/yx45011a-configure /usr/local/sbin/yx45011a-uninstall
